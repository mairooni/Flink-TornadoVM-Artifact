...
public class ExamineUDF {
    ...
    // based on the information extracted from the visitor, the necessary variables
    // are initialized
    public static void setTypeVariablesMap() throws Exception {
        ...
        if (argType.contains("Integer")) {
            ...
            // inDesc =
            // "(Lorg/apache/flink/api/java/tuple/Tuple2)Lorg/apache/flink/api/java/tuple/Tuple2;";
            skeletonMapDesc = "(Lorg/apache/flink/api/java/tuple/Tuple2;)";
            tornadoMapMethod = "Tuple2[],";
            // throw new Exception("Argument type " + argType + " not supported on TornadoVM
            // yet.");
        ...
        if (returnType.contains("Integer")) {
            ...
            // throw new Exception("Return type " + returnType + " not supported on
            // TornadoVM yet.");
