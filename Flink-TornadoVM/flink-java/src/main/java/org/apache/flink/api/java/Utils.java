...
public final class Utils {
	...
	public static boolean tornadoVM = false;
	...
	public static String getCallLocationName(int depth) {
		...
		if (tornadoVM) {
			return String.format("%s(%s:%d) %s", elem.getMethodName(), elem.getFileName(), elem.getLineNumber(), "tornado");
		} else {
	...
	public static class CollectHelper<T> extends RichOutputFormat<T> {
		...
		public SerializedListAccumulator<T> accumulator;
