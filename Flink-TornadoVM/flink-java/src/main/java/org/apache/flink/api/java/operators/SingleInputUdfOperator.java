...
public abstract class SingleInputUdfOperator<IN, OUT, O extends SingleInputUdfOperator<IN, OUT, O>>
	...
	public O withBroadcastSet(DataSet<?> data, String name) {
		...
		if (data instanceof DataSource) {
			DataSource broadcastedData = (DataSource) data;
			broadcastedData.broadcasted();
		} else if (data instanceof IterativeDataSet) {
			if (((IterativeDataSet) data).getInput() instanceof DataSource) {
				DataSource broadcastedData = (DataSource) ((IterativeDataSet) data).getInput();
				broadcastedData.broadcasted();
			}
		}
