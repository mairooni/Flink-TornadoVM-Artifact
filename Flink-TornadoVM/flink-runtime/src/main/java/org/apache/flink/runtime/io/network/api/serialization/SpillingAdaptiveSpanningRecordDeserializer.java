...
public class SpillingAdaptiveSpanningRecordDeserializer<T extends IOReadableWritable> implements RecordDeserializer<T> {
	...
	public byte[] getNonSpanningBytes() {
//		int recordLen = nonSpanningWrapper.readInt();
//		byte[] b = new byte[recordLen];
//		for (int i = 0; i < recordLen; i++) {
//			b[i] = nonSpanningWrapper.readByte();
//		}
//		return b;
		return nonSpanningWrapper.getDataInBytes();
	}

//	public Tuple2<DeserializationResult, byte[]> getNonSpanningBytes() {
//		try {
//			int recordLen = nonSpanningWrapper.readInt();
//			byte[] b = new byte[recordLen];
//			if (nonSpanningWrapper.canReadRecord(recordLen)) {
//				DeserializationResult d = nonSpanningWrapper.readByteRecord(b);
//				return new Tuple2<>(d, b);
//			} else {
//				//spanningWrapper.transferFrom(nonSpanningWrapper, recordLen);
//				DeserializationResult d = PARTIAL_RECORD;
//				return new Tuple2<>(d, b);
//			}
//		} catch (IOException e) {
