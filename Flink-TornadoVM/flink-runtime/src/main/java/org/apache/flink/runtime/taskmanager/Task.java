...
public class Task implements Runnable, TaskSlotPayload, TaskActions, PartitionProducerStateProvider, CheckpointListener, BackPressureSampleableTask {
	...
	//public static HashMap<String, TypeInformation> kmeansFunctionsTypeInfo;
	...
	public Task(
		...
		if (taskInformation.getTypeInfo() != null) {
			//if (AbstractInvokable.typeInfo == null) {
				AbstractInvokable.typeInfo = taskInformation.getTypeInfo();
			//}
		}
	}
	...
	private void doRun() {
		...
		try {
			...
			//System.out.println("****** TASK: " + taskNameWithSubtask + " taskConf: " + taskConfiguration);
		...
		//	System.out.println("\n *** Task: start = " + taskStart + " - end = " + taskEnd + " for " + this.taskNameWithSubtask.toString() + "\n");
		}
		catch (Throwable t) {
