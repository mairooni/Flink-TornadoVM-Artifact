...
__kernel void reduce(__global uchar *_heap_base,
     ...
     // Frame:
     //        83        , 1,         2  ,      83
     // 3: [ double1[], integer1, integer1, double2[], integer2, integer2, double3[], integer3, integer3  ... ]  (Input)
     // 4: [ double[]]  (Input2, product of map function)
    ...
    if (idx == 0) {
        ...
        for (int i = 0; i < arraySize; i++) {
            in = *((__global double *) ((8 * i) + 24L + ul_1));
            ulong ul_3 = (8 * i) + 24L + ul_2;
            *((__global double *) ul_3) = in;
            // output[((arraySize + 2) * idx + i)] = input2[((arraySize + 2) * idx + i)];
        }
        int f1 = *((__global int *) (arraySize * 8 + 24L + ul_0));
        ulong ul_4 = arraySize * 8 + 24L + ul_2;
    ...
    // size of array + 2
    int f2 = *((__global int *) ((arraySize*8 + 8) + (arraySize*8 + 16)*idx + 24L + ul_0));
