...
import static org.apache.flink.api.asm.ExamineUDF.*;
...
public class TransformUDF {
	...
	public static String tornadoReduceName;
	...
	public static class MapMethodAdapter extends LocalVariablesSorter {
		...
		public void visitCode() {
			...
			if (!inOwner.contains("Tuple") && !inOwner.contains("Float[]")) {
			...
			if (!outOwner.contains("Tuple") && !inOwner.contains("Float[]")) {
	...
	public static class ReduceConstructorAdapter extends LocalVariablesSorter {
		...
		public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
			...
			if (Opcodes.INVOKESPECIAL == opcode) {
				...
				mv.visitFieldInsn(Opcodes.PUTFIELD, tornadoReduceName, "udf", "L" + redUserClassName + ";");
			}
	...
	public static class ReduceMethodAdapter extends LocalVariablesSorter {
		...
		public void visitCode() {
			mv.visitVarInsn(Opcodes.ALOAD, 0);
			mv.visitFieldInsn(Opcodes.GETFIELD, tornadoReduceName, "udf", "L" + redUserClassName + ";");
			mv.visitVarInsn(gLoad, 1);
