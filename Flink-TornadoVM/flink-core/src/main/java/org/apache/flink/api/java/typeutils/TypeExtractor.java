...
public class TypeExtractor {
	...
	//public static HashMap<String, TypeInformation> kmeansFunctionsTypeInfo = new HashMap<>();
...
//		if (kmeansFunctionsTypeInfo.get(typeHierarchy.get(0).toString()) == null) {
//			kmeansFunctionsTypeInfo.put(typeHierarchy.get(0).toString(), in1Type);
//		}
		return subTypesInfo;
	}
